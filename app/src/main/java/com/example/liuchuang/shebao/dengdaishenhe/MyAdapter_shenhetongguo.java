 ...
 * 重写的Adapter
 */
public  class MyAdapter_shenhetongguo extends BaseAdapter {
     ...
     */
    public MyAdapter_shenhetongguo(Context context, List<ImageEntry> list){
...
//        return mList.get(position).getId();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(null==convertView){
            convertView = LayoutInflater.from(context).inflate(R.layout.item_shenhetongguo_tupian, null, false);
