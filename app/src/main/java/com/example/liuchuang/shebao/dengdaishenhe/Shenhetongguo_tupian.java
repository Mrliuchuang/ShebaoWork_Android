package com.example.liuchuang.shebao.dengdaishenhe;
...
public class Shenhetongguo_tupian extends Activity implements XListView.IXListViewListener {

    private XListView mListView;
    private Handler mHandler_tupian;
    private MyAdapter_shenhetongguo myAdapter;
    List<ImageEntry> mList_tupian;
    //要显示的参数及图片地址
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shenhetongguo_tupian);
        mListView = (XListView) findViewById(R.id.xlistview_shenhetongguo_tg);
        //mainAdapter = new MainAdapter(this);//实例化一个适配器对象

        //实例化一个图片数组列表对象
        mList_tupian = new ArrayList<ImageEntry>();
        //datas = new ArrayList<>();
        mHandler_tupian = new Handler();
        //设置数据
        geneItems();
...
//                        int id = jsonObject.getInt("id");
        ...
        myAdapter = new MyAdapter_shenhetongguo(this,mList_tupian);
    ...
    public void onRefresh() {
        mHandler_tupian.postDelayed(new Runnable() {
            @Override
            public void run() {

                mList_tupian.clear();//清空数组列表变量
                geneItems();
