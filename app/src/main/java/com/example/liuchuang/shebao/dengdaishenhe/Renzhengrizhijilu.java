...
import com.example.liuchuang.shebao.work.Dengdaishenhe_work;
...
public class Renzhengrizhijilu extends Activity implements XListView.IXListViewListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dengdaishenhe_work_tupian);
        mListView = (XListView) findViewById(R.id.xlistview_tupian);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(Renzhengrizhijilu.this, "i:" + (i ), Toast.LENGTH_SHORT).show();
...
//                        int id = jsonObject.getInt("id");
                        ...
                        myAdapter = new MyAdapter(Renzhengrizhijilu.this,mList_tupian);
